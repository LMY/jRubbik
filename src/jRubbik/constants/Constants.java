...
public class Constants {
	...
	/**
	 * Colors of the 8 corners, in order
	 */
	...
	/**
	 * Colors of the 12 edges, in order
	 */
	 ...
	 * The Color order
	 */
	public final static Color[][] COLOR_ORDER = new Color[][]{
	 ...
	 * performing permutate(corners, corners_permF, bool inverse) does an F/F'
	 */
	...
	/**
	 * corner permutation of the 6 faces.
	 * order is the same as Enum Color, F is corners_permutations[0] because Color.RED.toInt()=0, U=YELLOW, ... and so on
	 */
	...
	/**
	 * edges of the F face
	 * performing permutate(edges, edges_permF, bool inverse) does an F/F'
	 */
	...
	/**
	 * edge permutation of the 6 faces.
	 * order is the same as Enum Color, F is edges_permutations[0] because Color.RED.toInt()=0, U=YELLOW, ... and so on
	 */
	 ...
	 * @param value
	 */
	public static int move_const_rot_axis(final int value) {	// final int value =  static_cast<unsigned int>(dir);
	...
	/**
	 * To get Color[9] of the 6 faces, after an orientation swaps faces to match the actual state orient each face must be rotated of:
	 * pos0 is OrientationState.UP
	 * pos1 is OrientationState.FRONT
	 * 
	 * pos2 how many times to rotate face Color.RED
	 * pos3 how many times to rotate face Color.RED + 1
	 * ...
	 * pos7 how many times to rotate face Color.BLUE
	 */
	...
	/**
	 * corners_incommon[c1][c2] = how many colors the corners c1 and c2 have in common
	 */
	...
	/**
	 * returns how many colors the corners c1 and c2 have in common
	 * @param c1
	 * @param c2
	 * @return 0,1,2
	 */
